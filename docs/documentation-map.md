...
- [`docs/semiconductor-process-spec.md`](./semiconductor-process-spec.md): 工程図鑑の薄膜・組立の仕事紹介・おすすめ見学コース・全体像・ウエハ準備／薄膜加工／配線＋CMP／組立／ウエハ・最終検査の図・技術簡略化・共通操作・体験別計測・公開導線・検証。

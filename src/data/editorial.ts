...
export const rankings: Ranking[] = [
  {
    ...
    companyIds: ["tokyo-electron", "screen", "advantest", "applied-materials", "lam-research", "asml", "kla", "teradyne"],
  ...
  },
  {
    ...
    companyIds: ["tsmc", "micron", "kioxia", "renesas", "rohm", "samsung-electronics", "onsemi", "infineon"],
  ...
  },
  {
    ...
    companyIds: ["nvidia", "amd", "asml", "applied-materials", "lam-research", "micron", "infineon", "nxp"],

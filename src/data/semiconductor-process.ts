...
export const processCopy = {
  ...
  description: 'ウエハ準備、薄膜加工、配線づくり＋CMP、組立、ウエハ検査、最終検査の6体験。おすすめ見学コースで順番に巡るか、気になる工程から体験できます。各約3〜5分、動く図で製造の流れを学び、各工程を支える仕事も知ることができます。',
...
export const processSources = [
  { id: 'sumco-wafer', title: 'SUMCO：シリコンウエハの製造方法', url: 'https://www.sumcosi.com/products/process/' },

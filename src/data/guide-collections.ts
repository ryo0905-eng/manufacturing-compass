...
export const industryGuideCollections: IndustryGuideCollection[] = [
  {
    ...
    guides: [
      ...
      { slug: "semiconductor-equipment-sales-ranking", shortTitle: "製造装置メーカーの売上高ランキング" },
      { slug: "memory-manufacturer-ranking", shortTitle: "DRAM・NANDのメーカー別売上シェア" },
      { slug: "optical-semiconductor-manufacturers", shortTitle: "光半導体メーカーの用途別比較" },

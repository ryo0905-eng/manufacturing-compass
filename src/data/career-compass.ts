...
export const goalOptions: CompassOption[] = [
  ...
  { id: "income", label: "年収を上げる", description: "選択肢と条件を広げる" },
];
...
export const marketValueProfiles: Record<string, MarketValueProfile> = {
  ...
  mechanical: {
    ...
    shortLabel: "装置設計型",
    summary: "機械・電気・制御の設計経験は、製造装置メーカーの求人要件と接点を作りやすい経験です。",
    baseScore: 66,
    salaryRangeCurrent: "500〜700万円",
  ...
  "sales-fae": {
    ...
    englishTalkTrack: "このタイプは英語力によって応募先の選択肢が広がりやすいです。技術説明と顧客対応の練習から始めましょう。",
  },
  beginner: {
    id: "beginner",

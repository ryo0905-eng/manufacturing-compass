...
type ToolId = "gage-rr" | "control-chart" | "yield-analysis" | "cpk" | "doe" | "line-balance" | "oee";
...
const tools = [
  ...
  { id: "cpk", href: "/tools/cpk", step: "04", question: "規格を満たせる能力があるか", title: "Cp・Cpk", role: "安定した工程の能力を評価", badge: "人気", message: "ばらつきだけでなく、中心のずれも評価する", description: "工程が安定していることを確認した後、規格幅に対するばらつきと中心のずれを評価します。", features: ["Cp・Cpk / Pp・Ppk", "ヒストグラム", "中心ずれの比較"], time: "3〜8分", level: "入門", preview: "cpk" },
  { id: "doe", href: "/tools/doe", step: "05", question: "どう改善するか", title: "実験計画法（DoE）", role: "改善条件を効率的に探索", badge: "次の一歩", message: "複数の条件を、効率よく比較する", description: "複数因子の主効果と交互作用を読み、改善条件を少ない実験で探索します。", features: ["2因子2水準", "交互作用・ANOVA", "残差・確認実験"], time: "8〜15分", level: "基礎", preview: "doe" },
  { id: "line-balance", href: "/tools/line-balance", step: "06", question: "工程の負荷は偏っていないか", title: "山積み表・ラインバランス", role: "作業配分を比較", badge: "実務ツール", message: "作業を移し、タクト超過の変化を見る", description: "工程別の作業時間を積み上げ、再配分前後の負荷を比較します。", features: ["積み上げ棒グラフ", "タクト超過", "配分の基準比較"], time: "3〜8分", level: "入門", preview: "balance" },
  { id: "oee", href: "/tools/oee", step: "07", question: "どのロスを改善するか", title: "OEE改善シミュレーター", role: "設備ロスを比較", badge: "実務ツール", message: "停止・速度・不良を、良品数につなげる", description: "OEEの内訳と改善シナリオから、推定良品生産量を比較します。", features: ["OEE自動計算", "3つのロス", "推定良品数"], time: "3〜5分", level: "入門", preview: "oee" },
] as const;

...
import { DoePracticeTool } from "@/components/DoePracticeTool";
...
export function DoeLearningTool() {
  const [learningMode, setLearningMode] = useState<"effects" | "experiment" | "decision" | "diagnosis" | "confirmation">("effects");

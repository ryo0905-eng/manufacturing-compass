...
export default function ProcessComparisonPage() {
  return <main className={styles.page}>
    ...
    <nav className={styles.nav} aria-label="関連ツール">{isCorrelationPublished() && <Link href={correlationRoute}>相関と因果の違いを体験する</Link>}<Link href="/tools/cpk">規格に対する工程能力を確認する</Link><Link href="/tools/doe">実験計画法を学ぶ</Link><Link href="/tools/control-chart">時系列の安定性を学ぶ</Link></nav>

...
export default function GageRrPage(){return <main className="grr-page">
  ...
  <section className="grr-document"><h2>画像の良否判定も体験する</h2><p>Gage R&amp;Rで扱う連続値の測定評価とは別に、画像から良品・不良品を分ける検査を試せます。</p><Link href="/tools/ai-visual-inspection">AI外観検査ラボ：ルールとAIを比較（教育用・試用版） →</Link></section>

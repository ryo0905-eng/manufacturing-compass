  ...
  return <main className={styles.page}>
    ...
    <article className={styles.document}>
      ...
      <section aria-labelledby="ranking-scope"><h2 id="ranking-scope">比較モードと対象範囲</h2>
        ...
        <ul><li>半導体20社：装置5社を含む20社、2010〜2025年。</li><li>世界の大企業と比較：半導体・装置20社とGAFAM・トヨタの26社、2014〜2025年。</li><li>製造装置5社：ASML、Applied Materials、Lam Research、東京エレクトロン、KLA、2010〜2025年。</li><li>日本企業10社：半導体メーカー2社、装置・検査5社、材料3社、2010〜2025年。</li></ul>
        ...
        <details><summary>日本企業10社と各社のデータ出典</summary><ul>{[...companies.filter(company => company.id === 'tokyo-electron'), ...japanCompanies].map(company => <li key={company.id}><a href={company.sourceUrl}>{company.name}</a> · {company.category} · 確認日 {company.checkedAt ?? meta.checkedAt}</li>)}</ul></details>
        <p>日本企業モードは長期比較のため選定した10社です。各年の日本TOP10ではなく、キオクシアなど上場期間が短い企業や非上場企業を含みません。SCREENは持株会社全体、信越化学も半導体以外の事業を含む評価額です。現在の名称・ロゴは各年当時の姿を再現していません。</p>
      ...
      <section aria-labelledby="ranking-sources"><h2 id="ranking-sources">データソース・集計方法・注意事項</h2>
        <dl className={styles.definition}>
          ...
          <dt>対象期間</dt><dd>半導体・装置・日本企業は2010〜2025年、他業界比較は2014〜2025年の各年末。2026年途中の値は含みません。</dd>
          ...
          <dt>順位</dt><dd>各モードの対象20社・26社・5社・日本10社内で時価総額の降順。同じ丸め値は同順位とし、その次は人数分だけ順位が進みます。表示順のみ企業IDで固定します。</dd>

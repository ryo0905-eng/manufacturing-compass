...
export default function SemiconductorProcessPage() {
  return <main className={styles.page}>
    ...
    <header className={styles.hero}><p className={styles.eyebrow}>触って分かる工程図鑑 · 教育用 · 各体験 約3〜5分</p><h1>{processCopy.heading}</h1><p>膜に形を作る前工程。チップを切り分け、つなぎ、保護する後工程。<br/>薄膜加工・配線づくり＋CMP・組立の3体験を動かして、ウエハから製品になる流れを確かめましょう。</p><p className={styles.small}>{processCopy.privacy}</p></header>
    <ProcessExplorer/>

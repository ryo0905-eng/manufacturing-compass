  ...
  return (
    <main className="page">
      ...
      <section className="legal-layout">
        <article>
          <h2>Cpk・工程比較の入力保存について</h2>
          <p>「入力を保存」を選ぶと、測定値、規格、入力した名称などを含むJSONファイルのダウンロードを開始します。保存ファイルは利用者が管理します。計算結果は保存しません。ファイルの読み込みと検証はブラウザ内で行い、サーバーや外部APIへ送信しません。自動保存、ブラウザの永続ストレージへの保存、共有URLへの入力データの埋め込みは行いません。</p>

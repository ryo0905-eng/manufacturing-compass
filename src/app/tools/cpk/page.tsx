...
export default function CpkToolPage() {
  return (
    <main className="cpk-page cpk-page--analysis">
      ...
      <nav className="tool-related-links" aria-label="関連する実務学習ツール"><span>関連ツール</span><Link href="/guides/six-sigma">シックスシグマとDMAICの全体像 <span aria-hidden="true">→</span></Link><Link href="/tools/control-chart">管理図で工程の時間変化を学ぶ <span aria-hidden="true">→</span></Link><Link href="/tools/doe">実験計画法を動かして学ぶ <span aria-hidden="true">→</span></Link></nav>

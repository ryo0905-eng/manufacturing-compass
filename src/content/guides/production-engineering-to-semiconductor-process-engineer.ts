...
export const productionEngineeringToSemiconductorProcessEngineerGuide: GuideArticle = {
  ...
  description: "電子部品の工程改善経験とPython・データ分析を、半導体の会社のプロセス改善職へつなげた実体験を整理します。",
  ...
  experienceBasis: [
    ...
    "半導体の会社で、複数工程のプロセス改善とデータ活用に関わる職種からオファーを得た選考経験",
  ],
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "応募先は半導体の会社です。私は電子部品メーカーで、複数の製造工程と半導体関連部品の生産技術に携わってきたため、完全な未経験領域への転職とは考えていません。一方で、半導体前工程そのものを経験していたわけではなく、経験していない工程まで、できるとは説明しませんでした。",

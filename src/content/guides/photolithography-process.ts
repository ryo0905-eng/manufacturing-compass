      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "イオン注入・拡散の仕組み", href: "/guides/semiconductor-ion-implantation-process", description: "レジスト開口を使ってドーピング領域を作る流れを見る" },
          ],
        },
        {
          type: "note",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "重ね合わせ計測装置メーカー", href: "/guides/semiconductor-overlay-metrology-manufacturers", description: "上層と下層の位置差を画像・回折で測る装置を見る" },

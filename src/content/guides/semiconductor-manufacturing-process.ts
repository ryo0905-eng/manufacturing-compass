      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "フォトマスクメーカー", href: "/guides/semiconductor-photomask-manufacturers", description: "設計データをウェーハ転写用の原版へ変える企業を見る" },
            { label: "マスクブランクスメーカー", href: "/guides/semiconductor-mask-blank-manufacturers", description: "完成マスクの母材となる基板・薄膜材料と主要企業を見る" },
            { label: "フォトレジストメーカー", href: "/guides/semiconductor-photoresist-manufacturers", description: "パターン形成を支える感光材料と主要企業を見る" },
            { label: "半導体ガスメーカー", href: "/guides/semiconductor-gas-manufacturers", description: "成膜・エッチング・洗浄を支えるガス材料と主要企業を見る" },
            { label: "高純度薬液メーカー", href: "/guides/semiconductor-high-purity-chemical-manufacturers", description: "洗浄・ウェット加工・CMPを支える液体材料と主要企業を見る" },
            ...
            { label: "CMPスラリーメーカー", href: "/guides/semiconductor-cmp-slurry-manufacturers", description: "平坦化を支える砥粒・薬液材料と主要企業を見る" },
            ...
            { label: "ウェーハ欠陥検査装置メーカー", href: "/guides/semiconductor-wafer-defect-inspection-manufacturers", description: "前工程で粒子・傷・パターン異常の候補を探す装置を見る" },
            { label: "欠陥レビューSEMメーカー", href: "/guides/semiconductor-defect-review-sem-manufacturers", description: "検査候補を高倍率画像・分類・原因解析へつなぐ装置を見る" },

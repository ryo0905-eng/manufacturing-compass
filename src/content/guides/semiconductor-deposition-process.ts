      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "酸化・熱処理の仕組み", href: "/guides/semiconductor-oxidation-thermal-process", description: "熱酸化による成長膜とCVD・ALDの堆積膜、アニールの役割を比較する" },
            { label: "CMP・平坦化の仕組み", href: "/guides/semiconductor-cmp-process", description: "埋め込み後の余分な膜を除去し、高さをそろえる工程を見る" },
            { label: "配線形成の仕組み", href: "/guides/semiconductor-interconnect-process", description: "絶縁膜、バリア／ライナー、導体薄膜を一つの配線構造へ統合する流れを見る" },
            { label: "検査・計測の仕組み", href: "/guides/semiconductor-inspection-metrology", description: "膜厚・面内均一性・欠陥を測り、成膜工程へ返す流れを見る" },
            { label: "膜厚・光学計測装置メーカー", href: "/guides/semiconductor-thin-film-optical-metrology-manufacturers", description: "分光反射・エリプソメトリで膜厚と膜質を測る装置を見る" },

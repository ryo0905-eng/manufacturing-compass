      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "熱処理装置メーカー", href: "/guides/semiconductor-thermal-processing-equipment-manufacturers", description: "バッチ炉・RTP・ミリ秒アニールと主要企業を見る" },
            { label: "ダイシング装置メーカー", href: "/guides/semiconductor-dicing-equipment-manufacturers", description: "ブレード・レーザー・プラズマ個片化装置と主要企業を見る" },
            { label: "パッケージング装置メーカー", href: "/guides/semiconductor-packaging-equipment-manufacturers", description: "ダイ・ワイヤ・先端接合、封止装置と主要企業を見る" },
            { label: "テストハンドラメーカー", href: "/guides/semiconductor-test-handler-manufacturers", description: "搬送・温度・接触・分類装置と主要企業を見る" },
            { label: "ウェーハプローバメーカー", href: "/guides/semiconductor-wafer-prober-manufacturers", description: "ウェーハ位置合わせ・接触装置と主要企業を見る" },
            { label: "プローブカードメーカー", href: "/guides/semiconductor-probe-card-manufacturers", description: "テスタとダイをつなぐ接触部品と主要企業を見る" },
            { label: "テストソケットメーカー", href: "/guides/semiconductor-test-socket-manufacturers", description: "パッケージテストの接触部品と主要企業を見る" },
            ...
            { label: "検査・計測装置メーカー", href: "/guides/semiconductor-inspection-equipment-manufacturers", description: "装置カテゴリーと主要企業を見る" },

...
export const semiconductorCareerEnglishLevelGuide: GuideArticle = {
  ...
  description: "TOEIC約600点・会話経験ほぼなしで海外勤務を始めたRYOが、2.5年の実務と半導体の会社のポジションの選考で、実際に確認された英語力を振り返ります。",
  ...
  experienceBasis: [
    ...
    "半導体の会社のポジションの技術面接・人事面接を受け、オファーを得た経験",
  ],
  ...
  overviewBlocks: [
    {
      ...
      items: [
        ...
        { label: "03", title: "半導体の会社へ", body: "TOEIC 780点を記載し、英語確認を含む選考へ" },
      ],
    },
  ],
  sections: [
    {
      ...
      paragraphs: [
        "私が応募した半導体の会社のポジションには、英語がmustとは書かれていませんでした。Business levelやFluentなどの記載もなかったため、英語力を理由に応募を迷うことはありませんでした。",

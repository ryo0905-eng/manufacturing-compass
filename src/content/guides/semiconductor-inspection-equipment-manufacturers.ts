      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "ペリクルメーカー", href: "/guides/semiconductor-pellicle-manufacturers", description: "膜欠陥・粒子・フレームを管理する保護部材企業を見る" },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "CD-SEM・電子線計測装置メーカー", href: "/guides/semiconductor-cd-sem-manufacturers", description: "測長SEM、電子線欠陥検査、レビュー装置の違いを見る" },
            { label: "膜厚・光学計測装置メーカー", href: "/guides/semiconductor-thin-film-optical-metrology-manufacturers", description: "分光反射・エリプソメトリ・OCDと主要企業を見る" },
            { label: "重ね合わせ計測装置メーカー", href: "/guides/semiconductor-overlay-metrology-manufacturers", description: "画像式・回折式・電子線式の層間位置計測を見る" },
            { label: "ウェーハ欠陥検査装置メーカー", href: "/guides/semiconductor-wafer-defect-inspection-manufacturers", description: "パターンなし・付き、明視野・暗視野、レビュー連携を見る" },
            { label: "欠陥レビューSEMメーカー", href: "/guides/semiconductor-defect-review-sem-manufacturers", description: "欠陥座標の再検出、電子線撮像、ADR・ADC、分類を見る" },
            { label: "フォトマスク検査装置メーカー", href: "/guides/semiconductor-photomask-inspection-equipment-manufacturers", description: "ブランクス・パターン・EUVマスク検査を詳しく見る" },

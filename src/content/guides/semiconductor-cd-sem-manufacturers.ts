      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "重ね合わせ計測装置メーカー", href: "/guides/semiconductor-overlay-metrology-manufacturers", description: "電子線と光学による上下層の位置計測を詳しく見る" },
            { label: "ウェーハ欠陥検査装置メーカー", href: "/guides/semiconductor-wafer-defect-inspection-manufacturers", description: "広く候補を探す光学検査と電子線レビュー・寸法計測の役割差を見る" },
            { label: "欠陥レビューSEMメーカー", href: "/guides/semiconductor-defect-review-sem-manufacturers", description: "検査候補の再検出、ADR・ADC、欠陥パレートを詳しく見る" },

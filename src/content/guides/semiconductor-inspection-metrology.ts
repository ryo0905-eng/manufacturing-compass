      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "重ね合わせ計測装置メーカー", href: "/guides/semiconductor-overlay-metrology-manufacturers", description: "上下層のX・Yずれを画像・回折・電子線で測る装置と企業を見る" },
            { label: "ウェーハ欠陥検査装置メーカー", href: "/guides/semiconductor-wafer-defect-inspection-manufacturers", description: "広いウェーハ面から粒子・傷・パターン異常の候補を探す装置と企業を見る" },
            { label: "欠陥レビューSEMメーカー", href: "/guides/semiconductor-defect-review-sem-manufacturers", description: "検査候補を高倍率像・自動分類・欠陥パレートへ変える装置と企業を見る" },
            ...
            { label: "ウェーハテストの仕組み", href: "/guides/semiconductor-wafer-test", description: "形成済みダイの機能・電気特性を確認する後続工程を見る" },
